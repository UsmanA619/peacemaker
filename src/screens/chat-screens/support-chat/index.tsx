...
export default function SupportChat({route}: Props) {
  const [chat_log, setChat_log] = React.useState<chatData[]>([
    ...
    {
      messageSent: false,
      text: 'Hey Akiza! Thank you for messaging us, we will immediately get back to you about this issue. Thank you for your patience.',
    },
    {
      messageSent: true,
      text: 'Hey I wan’t a refund of this app! This isn’t working!',
    },
  ]);
  ...
  //   const navBarHeight = await getNavigationBarHeight();
  //   const result = navBarHeight / scale;

  //   setNavigationBarHeight(result);
  // };
  ...
  return (
    <GestureHandlerRootView style={{flex: 1}}>
      <View style={{flex: 1, backgroundColor: '#f9fafa'}}>
        <Text
          style={{textAlign: 'center', marginVertical: 16, color: '#656565'}}>
